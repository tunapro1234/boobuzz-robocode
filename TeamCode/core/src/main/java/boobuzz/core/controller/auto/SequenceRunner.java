...
public final class SequenceRunner {
    ...
    /** Aborts a sequence, preserving the reason for telemetry and tests. */
    public void abort(String reason) {
        if (!isFinished()) {
            failure = RequestStatus.rejected(primaryRequestId, reason == null ? "aborted" : reason);
        }
    }
